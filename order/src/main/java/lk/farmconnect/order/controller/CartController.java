...
import lk.farmconnect.order.dto.UpdateCartItemRequest;
...
public class CartController {
    ...
    public ResponseEntity<ApiResponse<CartResponse>> updateItemQuantity(
            ...
            @AuthenticationPrincipal User buyer) {
        return ResponseEntity.ok(ApiResponse.success(cartService.updateItemQuantity(buyer, itemId, request.quantity())));
    }
